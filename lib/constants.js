...
// Thương hiệu — đổi tên app ở DUY NHẤT chỗ này (Phase 1: gom về một hằng).
export const APP_NAME = "Tiny Football";
export const APP_TAGLINE = "Dự đoán & theo dõi thể thao";
